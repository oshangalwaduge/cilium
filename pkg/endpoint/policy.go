...
func (e *Endpoint) proxyID(l4 *policy.L4Filter, listener string) (string, uint16, uint16) {
	port := uint16(l4.Port)
	...
	return policy.ProxyID(e.ID, l4.Ingress, string(l4.Protocol), port, listener), port, uint16(l4.U8Proto)
}
