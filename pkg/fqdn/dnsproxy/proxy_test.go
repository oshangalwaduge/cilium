...
func (s *DNSProxyTestSuite) SetUpTest(c *C) {
	...
	s.proxy.lookupTargetDNSServer = func(w dns.ResponseWriter) (serverIP net.IP, serverPort, serverProto uint16, addrStr string, err error) {
